...
export default {
  ...
  module: {
    loaders: [
      ...
      {test: /\.css$/, include: path.join(__dirname, 'node_modules/antd'), loader: extractAntd.extract('css')},
      {test: /\.s?css$/, include: path.join(__dirname, 'src'), loader: extractCss.extract('css?modules!sass')}
    ]
  },
  resolve: {
